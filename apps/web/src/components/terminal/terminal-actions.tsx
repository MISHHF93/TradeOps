...
import { WatchlistButton } from '../commerce/watchlist-button';
...
export function ApprovalButtons({ approvalId }: { approvalId: string }) {
  ...
  return (
    <span className="approval-actions">
      <button type="button" className="btn approve" disabled={busy} onClick={() => void decide('approved')}>
        Approve
      </button>
      <button type="button" className="btn destructive" disabled={busy} onClick={() => void decide('rejected')}>
        Reject
      </button>
    </span>
  );
