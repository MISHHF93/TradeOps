...
export const LIVE_FEED_STRING_TO_BUSINESS: Record<string, BusinessCapability[]> = {
  ...
  subscriptions: ['read_payments'],
  payouts: ['reconcile_payments'],
  invoices: ['reconcile_payments'],
  shipments: ['monitor_fulfillment'],
  labels: ['monitor_fulfillment'],
  rates: ['calculate_landed_cost', 'monitor_fulfillment'],
  ...
  campaigns: ['generate_executive_insights'],
  ads: ['generate_executive_insights'],
  insights: ['generate_executive_insights'],
  audiences: ['generate_executive_insights'],
  conversions: ['estimate_demand', 'generate_executive_insights'],
  feeds: ['improve_seo', 'publish_listing'],
  content: ['optimize_product_content', 'improve_seo'],
  quotes: ['compare_suppliers', 'calculate_landed_cost'],
  events: ['generate_executive_insights', 'detect_exceptions'],
  metrics: ['generate_executive_insights'],
  traces: ['detect_exceptions'],
  logs: ['detect_exceptions'],
  errors: ['detect_exceptions'],
  alerts: ['detect_exceptions'],
};
